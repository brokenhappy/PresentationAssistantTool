...
actual class PlatformFileSystem actual constructor(basePath: String) : FileSystem {
    ...
    actual override suspend fun readText(path: String): String {
        return NSString.stringWithContentsOfFile(path, NSUTF8StringEncoding, null) ?: ""
    }

    @OptIn(ExperimentalForeignApi::class)
    actual override suspend fun writeText(path: String, content: String) {
    ...
    @OptIn(ExperimentalForeignApi::class)
    actual override suspend fun ensureParentExists(path: String) {
